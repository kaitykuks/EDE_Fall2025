...
read.csv(
  file="/home/EDE_Fall2025/Data/Raw/USGS_Site02085000_Flow_Raw.csv",
...
>Tip: Use autocomplete in the console instead of typing in the path... by doing
read.csv(home('HIT TAB')) Use the tab button until you get to the file you want.
...
```{r Exploring data}
# View(USGS.flow.data) # Need to commend out for knitting
...
dim(USGS.flow.data)  # Dimensions of an object (rows and columns)
length(USGS.flow.data)  # Length (columns)

head(USGS.flow.data)
head(USGS.flow.data, 10) # First 10 entried
tail(USGS.flow.data, 5) # Last 5 entries
USGS.flow.data[30000:30005, c(3, 8, 14)] # Look at rows 30000-30005 and columns 3, 8 ,14

class(USGS.flow.data$datetime) # Shows class of the column "datetime"
