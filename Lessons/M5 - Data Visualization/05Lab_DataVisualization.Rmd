...
# This won't run, check Slack for updated code (tidyverse doesn't support this anymore)
Plot_text <-
...
example_1 <- ggplot(PeterPaul.chem.nutrients %>% filter(depth == 0))  +
...
example_2 <- ggplot(PeterPaul.chem.nutrients) +
...
example_3 <- ggplot(EPAair, aes(x = PM2.5, y = Ozone, color = mean_Lat)) +
