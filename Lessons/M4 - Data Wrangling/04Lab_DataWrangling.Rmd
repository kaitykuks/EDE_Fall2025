...
> Answer: You are sorting based on the observation, not its location (you do not know its location as rows are always changing, hence you cannot sort based on rows).
