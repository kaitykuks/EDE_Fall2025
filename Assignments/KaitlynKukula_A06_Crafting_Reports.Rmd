...
```{r echo = FALSE, warning = FALSE, fig.align = "left", fig.cap="Ozone levels by month in 2018", fig.height=3.5, fig.width=6.5}

library(ggplot2)

# Create a boxplot for distribution of ozone levels by month in 2018

epa_data$Month <- factor(epa_data$Month, levels = c(1:12), labels = month.abb)

plot_2018 <- ggplot(epa_data %>% filter(Year == 2018)) +
...
```{r echo = FALSE, warning = FALSE, fig.align = "left", fig.cap="Ozone levels by month in 2019", fig.height=3.5, fig.width=6.5}

# Create a boxplot for distribution of ozone levels by month in 2019

plot_2019 <- ggplot(epa_data %>% filter(Year == 2019)) +
  geom_boxplot(aes(x = Month, y = Ozone)) +
  xlab("Month") +
  ylab(expression(paste('Concentration (', mu,"g/",m^{3}, ')'))) +
...
https://github.com/kaitykuks/EDE_Fall2025

I have not used any AI to complete this document and all problems attempts are my own work.
