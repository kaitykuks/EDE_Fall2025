...
EPAair_O3_PM25_NC1819_pivoted <- 
  ...
  pivot_wider(names_from = "AQS_PARAMETER_DESC", # what you want the categories to be
              ...
              id_cols = c("Date", "Site.Name")) # select the columns to base sorting on  
...
EPAair_O3_PM25_NC1819_Processed <- 
  full_join(EPAair_O3_PM25_NC1819_pivoted, EPAair_summaries)
...
#10: Get dimensions of the new dataset
